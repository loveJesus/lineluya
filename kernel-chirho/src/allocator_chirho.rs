...
/// Size of the kernel heap in bytes (512 MiB — needed for page cache + SSH server + large binaries).
/// With 2GB QEMU RAM, this leaves 1.5GB for physical frame allocation.
pub const HEAP_SIZE_CHIRHO: usize = 512 * 1024 * 1024;
