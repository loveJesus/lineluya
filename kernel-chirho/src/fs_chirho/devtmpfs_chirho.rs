...
static DEV_NODES_CHIRHO: &[DevNodeChirho] = &[
    ...
    DevNodeChirho { name_chirho: "tty0", major_chirho: 4, minor_chirho: 0, ops_chirho: &DEV_CONSOLE_OPS_CHIRHO, is_block_chirho: false },
    DevNodeChirho { name_chirho: "tty1", major_chirho: 4, minor_chirho: 1, ops_chirho: &DEV_CONSOLE_OPS_CHIRHO, is_block_chirho: false },
